      ...
      <footer className="Footer">
        <div className="Footer__content">
          <section className="Footer__content__left">
            <p>XIVCurrents v0.1.0 assembled by <a className="link link--light" href="http://eu.finalfantasyxiv.com/lodestone/character/5227277" target="_blank" rel="noreferrer noopener">Mayo Steakfries of Coeurl</a>. <br />
